...
# ---------------------------
# Add Phase-II backend to sys.path
# ---------------------------
_phase2_path = Path(__file__).parents[3] / "phase2" / "backend"
if str(_phase2_path) not in sys.path:
    sys.path.insert(0, str(_phase2_path))

# Add Phase-III backend to sys.path
_phase3_path = Path(__file__).parents[1]
if str(_phase3_path) not in sys.path:
    sys.path.insert(0, str(_phase3_path))

# ---------------------------
# Import Phase-II app
# ---------------------------
try:
    from app.main import app  # Phase-II FastAPI app
except Exception as e:
    print("Failed to import Phase-II app:", e)
    raise
...
try:
    ...
    print("Failed to import Phase-III chat_router:", e)
    raise
